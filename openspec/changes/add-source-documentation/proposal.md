...
- [ ] `features/auth/` → 对照 FILE_MAPPING.md Auth Module 部分
- [ ] `features/favorites/` → 对照 FILE_MAPPING.md Favorites Module 部分
- [ ] `features/player/` → 对照 FILE_MAPPING.md Player Module 部分
- [ ] `features/search/` → 对照 FILE_MAPPING.md 相关部分
- [ ] (etc.)
