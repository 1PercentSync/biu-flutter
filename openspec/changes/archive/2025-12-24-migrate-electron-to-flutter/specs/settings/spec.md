...
- Settings store: `biu/src/store/settings.ts`
- Default settings: `biu/shared/settings/app-settings.ts`
- Settings page: `biu/src/pages/settings/` (implied from screenshots)
...
Some desktop settings are not applicable:
- `autoStart` - Not applicable on iOS
- `closeWindowOption` - Not applicable on mobile
- `downloadPath` - Limited by iOS sandbox
- `ffmpegPath` - Not available on iOS
