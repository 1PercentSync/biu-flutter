...
- Layout: `biu/src/layout/index.tsx`
- Playbar: `biu/src/layout/playbar/`
- List items: `biu/src/components/music-list-item/`, `biu/src/components/mv-card/`
- Virtual list: `biu/src/components/virtual-list/`
- Image: `biu/src/components/image/`
- Search: `biu/src/layout/navbar/search/`
- Empty: `biu/src/components/empty/`
- Theme: `biu/src/components/theme/`
...
dependencies:
  ...
  flutter_staggered_animations: ^1.x
```
